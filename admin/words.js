...
systemDictionary = {
    ...
    "IP address of your LaMetric Time": {
        ...
        "fr": "Adresse IP de votre LaMetric Time",
        "it": "Indirizzo IP di LaMetric Time",
        "es": "Dirección IP de su hora de LaMetric",
        "pl": "Adres IP twojego czasu LaMetric",
        "zh-cn": "您的LaMetric Time的IP地址"
    },
    "Developer Token": {
        "en": "Developer Token",
        "de": "Entwickler-Token",
        "ru": "Жетон разработчика",
        "pt": "Token de desenvolvedor",
        "nl": "Ontwikkelaarstoken",
        "fr": "Jeton de développeur",
        "it": "Token sviluppatore",
        "es": "Token de desarrollador",
        "pl": "Token programisty",
        "zh-cn": "开发者令牌"
    },
    "Your personal developer token - you can get it <a href=\"https://developer.lametric.com/\">here</a>": {
        ...
        "fr": "Votre jeton de développeur personnel - vous pouvez l'obtenir <a href=\"https://developer.lametric.com/\">ici</a>",
        "it": "Il tuo token sviluppatore personale: puoi ottenerlo <a href=\"https://developer.lametric.com/\">qui</a>",
